...
namespace LearnixCRM.Infrastructure.Migrations
{
    ...
    [Migration("20260310121450_InitialMigration")]
            ...
            modelBuilder.Entity("LearnixCRM.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            UserId = 1,
                            CreatedAt = new DateTime(2026, 3, 10, 12, 14, 49, 838, DateTimeKind.Utc).AddTicks(7867),
                            CreatedBy = 1,
                            Email = "admin@learnixcrm.com",
                            FullName = "Administrator",
                            PasswordHash = "$2a$11$Rvv4LaUwGhOjJ32xeSRX../tjfPoMqq3DehBEK4SSq/cMeouK7hSC",
                            Status = 3,
                            UserRole = 1
                        });
                });
