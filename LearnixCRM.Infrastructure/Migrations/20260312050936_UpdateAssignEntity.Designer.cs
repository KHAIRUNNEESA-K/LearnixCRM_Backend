...
namespace LearnixCRM.Infrastructure.Migrations
{
    ...
    [Migration("20260312050936_UpdateAssignEntity")]
    partial class UpdateAssignEntity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LearnixCRM.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            UserId = 1,
                            CreatedAt = new DateTime(2026, 3, 12, 5, 9, 35, 983, DateTimeKind.Utc).AddTicks(9728),
                            CreatedBy = 1,
                            Email = "admin@learnixcrm.com",
                            FullName = "Administrator",
                            PasswordHash = "$2a$11$BVJchFp9FiFdKeWjQ1o8puznJQb9kdV.UOrU8pq.fai2UinnxJIpC",
                            Status = 3,
                            UserRole = 1
                        });
                });
            ...
            modelBuilder.Entity("LearnixCRM.Domain.Entities.Lead", b =>
                {
                    b.HasOne("LearnixCRM.Domain.Entities.Course", "Course")
                        .WithMany("Leads")
